    ...
    <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item" id="lancerTest">
                <a class="nav-link" href="index.php?controller=professeur&action=lancerTest">Lancer un test</a>
            </li>
            <li class="nav-item" id="suivreTest">
                <a class="nav-link" href="index.php?controller=professeur&action=suivreTest">Suivre un test</a>
            </li>
            <li class="nav-item" id="analyserResultats">
                <a class="nav-link" href="index.php?controller=professeur&action=analyserResultats">Analyser les
                    resultat</a>
            </li>
            <li class="nav-item" id="editerQcm">
                <a class="nav-link" href="index.php?controller=professeur&action=editerQcm">Edition d'un QCM</a>
            </li>
        </ul>
        <span class="navbar-text">
            <!-- <a href="#" class="btn btn-secondary btn-lg active" role="button"
                        aria-pressed="true">Configuration</a> -->
            <a href="index.php?controller=professeur&action=deconnexionProf" class="btn btn-danger btn-lg active"
